...
const FiltersContainer = ({ children }) => {
    return (
        <div className="flex rounded-md items-center justify-between p-4 bg-gray-700 border-b border-solid border-gray-600">
            {children}
        </div>
    )
}
...
export {FiltersContainer, ItemLeft, FilterButtonContainer, FilterButton};